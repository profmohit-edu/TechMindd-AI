...
class ResearchPlugin(BasePlugin):
    ...
    def reflector(self):
        return ResearchReflector()

    def template(self):
        return "research.jinja2"

    def order(self):
        return 10

    def create_agent(self, provider: Any, retriever: Any | None = None):
        return ResearchAgent(provider, retriever=retriever)
